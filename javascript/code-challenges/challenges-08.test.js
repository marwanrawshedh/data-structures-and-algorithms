...
------------------------------------------------------------------------------------------------ */
  ...
  const citiesAtoJ = (arr) => {
    ...
    arr.forEach(element => {
      ...
      let regex=/\b[A-J]/g
    let newstr=regex.test(element[0])
     newstr
      
    if( newstr){nwarr.push(element)}
